        ...
        <div className="services_grid">
          <div className="services_box">
            <div className="services_tex">
              ...
              <a
                className="button"
                href="https://wa.me/+923193223060?text=Hello! I'm planning to create a website and I need some information about it. Can you provide me with details? "
              >
                Buy Now
              </a>
            </div>
          ...
          <div className="services_box">
            <div className="services_tex">
              ...
              <a
                className="button"
                href="https://wa.me/+923193223060?text=Hello! I need to design a UI/UX. Can you help me with that?"
              >
                Buy Now
              </a>
            </div>
          ...
          <div className="services_box">
            <div className="services_tex">
              ...
              <a
                className="button"
                href="https://wa.me/+923193223060?text=Hello! I'm looking to purchase a domain and hosting. Could you please assist me with that? "
              >
                Buy Now
              </a>
            </div>
          ...
          <div className="services_box">
            <div className="services_tex">
              ...
              <p>
                ...
                strategies like keyword research, and link building. With our
                comprehensive approach, we ensure your website stays ahead in
                the digital landscape, attracting more visitors and maximizing
                online presence effectively .
              </p>
              <a className="button" href="https://www.seotoolers.com/">
                Buy Now
              </a>
            </div>
          </div>
